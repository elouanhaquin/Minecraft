...
ChunkNS::Tree::Tree(glm::ivec3 p_pos)
{
	...
	treeBlockPosition[4] = glm::ivec3(p_pos.x + 1, p_pos.y + 2, p_pos.z);
	treeBlockPosition[5] = glm::ivec3(p_pos.x - 1, p_pos.y + 2, p_pos.z);
	treeBlockPosition[6] = glm::ivec3(p_pos.x, p_pos.y + 3, p_pos.z);
	treeBlockPosition[7] = glm::ivec3(p_pos.x, p_pos.y + 2, p_pos.z - 1);
	treeBlockPosition[8] = glm::ivec3(p_pos.x, p_pos.y + 2, p_pos.z + 1);
}

ChunkNS::Tree* ChunkNS::Tree::moveTo(glm::vec3 p_pos)
{
	treeBlockPosition[0] = glm::ivec3(p_pos.x, p_pos.y, p_pos.z);
	treeBlockPosition[1] = glm::ivec3(p_pos.x, p_pos.y + 1, p_pos.z);
	treeBlockPosition[2] = glm::ivec3(p_pos.x, p_pos.y + 2, p_pos.z);
